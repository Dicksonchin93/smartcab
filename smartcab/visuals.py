...
def plot_trials(csv):
	...
	mean = [np.mean(1 - actions['good']) for i in actions['trial']]
	meanmin = [np.mean(actions['minor_acc']) for i in actions['trial']]
	meanmaj = [np.mean(actions['major_acc']) for i in actions['trial']]
	print ("mean of bad actions is :", mean)
	print ("mean of minor accident is :", meanmin)
	print ("mean of bad actions is :", meanmaj)
	...
	ax.plot(actions['trial'], mean, color='black', label='Mean Actions', linestyle='dashed', linewidth=3)
	...
	ax.plot(actions['trial'], meanmin, color='red', label='Mean Minor Accident', linestyle='dotted')
	ax.plot(actions['trial'], actions['major_acc'], color='red', label='Major Accident', linewidth=2)
	ax.plot(actions['trial'], meanmaj, color='red', label='Mean Major Accident', linestyle='dotted')
